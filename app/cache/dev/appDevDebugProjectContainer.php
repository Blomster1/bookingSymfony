...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_pgsql', 'host' => '127.0.0.1', 'port' => 5432, 'dbname' => 'booking', 'user' => NULL, 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    {
        $a = new \Doctrine\ORM\Mapping\Driver\SimplifiedYamlDriver(array(($this->targetDirs[3].'/src/UserBundle/Resources/config/doctrine') => 'UserBundle\\Entity', ($this->targetDirs[3].'/src/CoreBundle/Resources/config/doctrine') => 'CoreBundle\\Entity'));
        ...
        $c->addDriver($a, 'CoreBundle\\Entity');
        $c->addDriver($b, 'FOS\\UserBundle\\Entity');

        $d = new \Doctrine\ORM\Configuration();
        $d->setEntityNamespaces(array('UserBundle' => 'UserBundle\\Entity', 'FOSUserBundle' => 'FOS\\UserBundle\\Entity', 'CoreBundle' => 'CoreBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_b30f17bdbf53da5ea6d14d036bf4f8ffcf22c56345da45a4a22adb742c4273e4');
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'UserBundle\\Entity\\Users');
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/CalendarBundle/Resources/views'), 'Calendar');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('64f7085aac173ff04eb49158e11b4abdcef8dd88');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'secret' => '64f7085aac173ff04eb49158e11b4abdcef8dd88',
            'locale' => 'en',
            ...
            'kernel.secret' => '64f7085aac173ff04eb49158e11b4abdcef8dd88',
